...
import { products, productStocks, stockBatches, stockMovements, stores, orders } from '../drizzle/schema.js';
 ...
 */
async function updateStock(productId, storeId, quantityChange) {
